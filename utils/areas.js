export const AREAS = [
  ...
  { area: "東北", link: "tohoku", prefectures:
    [
      ...
      { name: "岩手県", link: "iwate" },
      { name: "宮城県", link: "miyagi" },
      { name: "秋田県", link: "akita" },
      { name: "山形県", link: "yamagata" },
  ...
  { area: "中国", link: "chugoku", prefectures:
    [
      ...
      { name: "岡山県", link: "okayama" },
      { name: "広島県", link: "hiroshima" },
  ...
  { area: "九州", link: "kyusyu", prefectures:
    [
      ...
      { name: "佐賀県", link: "saga" },
      { name: "長崎県", link: "nagasaki" },
      { name: "熊本県", link: "kumamoto" },
      { name: "大分県", link: "oita" },
      { name: "宮崎県", link: "miyazaki" },
      { name: "鹿児島県", link: "kagoshima" },
      { name: "沖縄県", link: "okinawa" },
    ]
  },
];